            ...
            <div class="bounds course--detail">
                ...
                <form>
                    ...
                    <div class="course--header">
                        ...
                        <div><input id="title" name="title" type="text" class="input-title course--title--input" placeholder="Course title..." value="" /></div>
                        <p>By Joe Smith</p>
                    </div>
                    ...
                    <div class="course--stats">
                        ...
                        <li class="course--stats--list--item">
                            ...
                            <div><input id="estimatedTime" name="estimatedTime" type="text" class="course--time--input" placeholder="Hours" value="" /></div>
                        </li>
                        <li class="course--stats--list--item">
